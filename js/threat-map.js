...
function updateMapSize() {
  ...
  const height = parent.clientHeight || (width * 0.625); // Maintain 16:10 aspect ratio
...
function drawHexes() {
  ...
  for (let row = -1; row * vertSpacing < height + buffer; row++) {
    for (let col = -1; col * horizSpacing < width + hexWidth; col++) {
